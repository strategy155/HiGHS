...
PYBIND11_MODULE(_core, m, py::mod_gil_not_used()) {
  ...
  py::class_<HighsOptions>(m, "HighsOptions", py::module_local())
      ...
      // HiPO solver options (MKL PARDISO backend)
      .def_readwrite("hipo_system", &HighsOptions::hipo_system)
      .def_readwrite("hipo_system_solver", &HighsOptions::hipo_system_solver)
      .def_readwrite("hipo_parallel_type", &HighsOptions::hipo_parallel_type)
      .def_readwrite("hipo_block_size", &HighsOptions::hipo_block_size)
